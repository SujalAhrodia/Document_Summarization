package documentsummerizationusingstackdecodermethod.score.importance;

import java.util.HashMap;
import java.util.List;
import java.util.Map;

import documentsummerizationusingstackdecodermethod.interfaces.ImportanceScorer;
...
public class UpperCaseCalculator implements ImportanceScorer{

	private static UpperCaseCalculator instance = new UpperCaseCalculator();
	...
	public UpperCaseCalculator getInstance(){
		return instance;
	}
}
